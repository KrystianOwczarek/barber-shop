...
export default function CirtyHeader3({ city, city2 }) {
  ...
  return (
    ...
    <section
      ...
      > 
        <p className='text-white text-xl'>Zapraszam do mojego salonu fryzjerstwa męskiego w okolicach {city2}! Oferuję profesjonalne strzyżenie, pielęgnację brody oraz stylizację fryzur. Jako doświadczony fryzjer męski zadbam o Twój wygląd, zapewniając usługi na najwyższym poziomie. Umów się na wizytę i odśwież swój styl!</p>
      </section>
    </>
  );
}